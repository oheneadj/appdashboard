<x-layouts::topnav>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 pb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <!-- Order -->
            <div class="card bg-white rounded-2xl p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-slate-100/50 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 group relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <p class="text-slate-500 text-xs font-bold uppercase tracking-wider mb-1">Order</p>
                            <h3 class="text-3xl font-bold text-slate-800 tracking-tight">276k</h3>
                        </div>
            ...
            <!-- Sales -->
            <div class="card bg-white rounded-2xl p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-slate-100/50 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 group">
                 <div class="flex justify-between items-start mb-4">
                    <div>
                        <p class="text-slate-500 text-xs font-bold uppercase tracking-wider mb-1">Sales</p>
                        <h3 class="text-3xl font-bold text-slate-800 tracking-tight">482k</h3>
                    </div>
            ...
            <div class="card bg-white rounded-2xl p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-slate-100/50 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 group">
                <div class="flex justify-between items-start mb-4">
                    <div>
                        <p class="text-slate-500 text-xs font-bold uppercase tracking-wider mb-1">New Visitors</p>
                         <h3 class="text-3xl font-bold text-slate-800 tracking-tight">$17,356</h3>
                    </div>
            ...
            <div class="card bg-white rounded-2xl p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-slate-100/50 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 group">
                 <div class="flex justify-between items-start mb-4">
                    <div>
                        <p class="text-slate-500 text-xs font-bold uppercase tracking-wider mb-1">Activity</p>
                        <h3 class="text-3xl font-bold text-slate-800 tracking-tight">$4,698</h3>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div class="card bg-white shadow-sm border border-slate-100 p-6">
                <div class="flex justify-between items-start mb-6">
                    <div>
                        <h3 class="font-bold text-slate-800">{{ __('Sale Country') }}</h3>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center">
                                <div class="{{ $country[3] }} h-6 rounded-r-full text-[10px] font-medium text-slate-600 flex items-center px-2 {{ $country[2] }}">
                                    {{ $country[1] }}
                                </div>
                            </div>
                        </div>
            ...
            <div class="card bg-white shadow-sm border border-slate-100 p-6">
                 <div class="flex justify-between items-start mb-6">
                    <h3 class="font-bold text-slate-800">{{ __('Payment History') }}</h3>
                    <button class="btn btn-sm btn-circle btn-ghost text-slate-400"><span class="icon-[tabler--dots-vertical] size-4"></span></button>
                </div>
                                ...
                                <tr class="border-b border-slate-50 last:border-none">
                                    <td class="pl-0 py-3">
                                        <div class="flex items-center gap-3">
                                            <div class="w-9 h-6 bg-slate-50 rounded border border-slate-200 flex items-center justify-center">
                                                 <span class="icon-[tabler--{{ $payment[0] }}] size-4 text-slate-600"></span>
                                            </div>
                                            <div>
                                                <div class="font-bold text-slate-700 text-xs">{{ $payment[1] }}</div>
                                                <div class="text-[10px] text-slate-400">{{ $payment[2] }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-3 text-xs text-slate-500">{{ $payment[3] }}</td>
                                    <td class="pr-0 py-3 text-right">
                                        <div class="font-bold text-slate-700 text-xs">{{ $payment[4] }}</div>
            ...
            <div class="card bg-white shadow-sm border border-slate-100 p-6">
                 <div class="flex justify-between items-start mb-6">
                    <h3 class="font-bold text-slate-800">{{ __('Performance') }}</h3>
                    <button class="btn btn-sm btn-circle btn-ghost text-slate-400"><span class="icon-[tabler--dots-vertical] size-4"></span></button>
                </div>
                
                <div class="flex border-b border-slate-100 mb-6">
                    <button class="pb-2 border-b-2 border-transparent text-slate-400 text-sm font-medium mr-4 hover:text-slate-600">New Users</button>
                    <button class="pb-2 border-b-2 border-indigo-600 text-indigo-600 text-sm font-medium mr-4">Online Sales</button>
                    <button class="pb-2 border-b-2 border-transparent text-slate-400 text-sm font-medium hover:text-slate-600">Daily Sales</button>
                </div>

                <div class="flex items-center justify-between mb-4">
                    <div>
                        <div class="text-xs text-slate-400">Digital Product</div>
                        <div class="text-lg font-bold text-slate-800 flex items-center gap-1">
                ...
                <div class="bg-slate-50 rounded-lg p-4 mb-4">
                    <div class="flex justify-between items-start mb-2">
                        <div>
                             <div class="text-xs text-slate-400">Physical Product</div>
                             <div class="text-2xl font-bold text-slate-800">$78,263</div>
                        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-2xl p-5 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-slate-100 flex flex-col lg:flex-row justify-between items-center gap-5">
                 <!-- Search -->
                 <div class="relative w-full lg:w-80 group">
                    ...
                    <input type="text" class="input input-sm h-11 w-full pl-11 bg-slate-50/50 border-slate-200 focus:bg-white focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 rounded-xl transition-all font-medium text-slate-600 placeholder:text-slate-400" placeholder="Search products...">
                </div>

                <div class="flex flex-wrap items-center gap-3 w-full lg:w-auto">
                    <!-- Filters -->
                    <div class="join border border-slate-200 rounded-xl bg-slate-50/50 p-1 gap-1">
                        <select class="select select-sm h-9 border-none bg-transparent focus:bg-white focus:shadow-sm focus:ring-0 text-slate-600 font-medium rounded-lg transition-all min-h-0 pl-3 pr-8 w-28 text-xs">
                            <option disabled selected>Status</option>
                            <option>Active</option>
                            <option>Inactive</option>
                        </select>
                        <div class="w-px bg-slate-200 my-1"></div>
                         <select class="select select-sm h-9 border-none bg-transparent focus:bg-white focus:shadow-sm focus:ring-0 text-slate-600 font-medium rounded-lg transition-all min-h-0 pl-3 pr-8 w-32 text-xs">
                    ...
                    <div class="flex items-center gap-3 ml-auto lg:ml-4">
                        <button class="btn btn-sm h-11 bg-white text-slate-600 border border-slate-200 hover:bg-indigo-50 hover:text-indigo-600 hover:border-indigo-200 gap-2 normal-case font-semibold rounded-xl shadow-sm hover:shadow transition-all px-5">
            ...
            <!-- Product Table -->
            <div class="bg-white rounded-2xl shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] border border-slate-100/50 overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="table w-full align-middle">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors group">
                                ...
                                <td class="py-3">
                                    <div class="flex items-center gap-4">
                                        <div class="avatar rounded-xl bg-slate-50 p-2 shadow-sm border border-slate-100">
                                            <div class="w-10 h-10">
                                                <img src="https://img.daisyui.com/images/profile/demo/2@94.webp" alt="iPhone 14 Pro" class="rounded-lg"/>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="font-bold text-slate-700 text-[15px] group-hover:text-indigo-600 transition-colors">iPhone 14 Pro</div>
                                ...
                                <td>
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-slate-600 font-medium text-sm">Electronics</span>
                                    </div>
                                </td>
                                <td>
                                    <input type="checkbox" class="toggle toggle-sm toggle-primary" checked />
                                </td>
                                <td class="text-slate-500 font-mono text-xs">SKU-19472</td>
                                <td class="text-slate-700 font-bold">$999.00</td>
                                <td class="text-slate-600 font-medium">665</td>
                                <td>
                                ...
                                <td class="text-right pr-6">
                                    <div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button class="btn btn-sm btn-square bg-white border border-slate-200 text-slate-500 hover:text-indigo-600 hover:border-indigo-200 hover:bg-indigo-50 shadow-sm rounded-lg transition-all"><span class="icon-[tabler--pencil] size-4"></span></button>
                                        <button class="btn btn-sm btn-square bg-white border border-slate-200 text-slate-500 hover:text-red-600 hover:border-red-200 hover:bg-red-50 shadow-sm rounded-lg transition-all"><span class="icon-[tabler--trash] size-4"></span></button>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors group">
                                    ...
                                    <div class="flex items-center gap-4">
                                        <div class="avatar rounded-xl bg-slate-50 p-2 shadow-sm border border-slate-100">
                                            <div class="w-10 h-10 flex items-center justify-center">
                                                <span class="icon-[tabler--device-speaker] size-6 text-slate-500"></span>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="font-bold text-slate-700 text-[15px] group-hover:text-indigo-600 transition-colors">Echo Dot (4th Gen)</div>
                                ...
                                <td class="text-slate-500 font-mono text-xs">SKU-72836</td>
                                <td class="text-slate-700 font-bold">$25.50</td>
                                <td class="text-slate-600 font-medium">827</td>
                                <td>
                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors group">
                                ...
                                <td class="py-3">
                                    <div class="flex items-center gap-4">
                                        <div class="avatar rounded-xl bg-slate-50 p-2 shadow-sm border border-slate-100">
                                            <div class="w-10 h-10 flex items-center justify-center">
                                                 <span class="icon-[tabler--clock] size-6 text-slate-500"></span>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="font-bold text-slate-700 text-[15px] group-hover:text-indigo-600 transition-colors">Dohioue Wall Clock</div>
                                ...
                                <td>
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-slate-600 font-medium text-sm">Household</span>
                                    </div>
                                </td>
                                <td>
                                    <input type="checkbox" class="toggle toggle-sm toggle-primary" checked />
                                </td>
                                <td class="text-slate-500 font-mono text-xs">SKU-29540</td>
                                <td class="text-slate-700 font-bold">$16.34</td>
                                <td class="text-slate-600 font-medium">804</td>
                                <td>
                                    <span class="badge badge-sm bg-emerald-50 text-emerald-600 border-emerald-100 font-semibold px-2.5 py-0.5">Published</span>
                                </td>
                                <td class="text-right pr-6">
                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors group">
                                ...
                                <td class="py-3">
                                    <div class="flex items-center gap-4">
                                        <div class="avatar rounded-xl bg-slate-50 p-2 shadow-sm border border-slate-100">
                                            <div class="w-10 h-10 flex items-center justify-center">
                                                <span class="icon-[tabler--shoe] size-6 text-slate-500"></span>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="font-bold text-slate-700 text-[15px] group-hover:text-indigo-600 transition-colors">INZCOU Running Shoes</div>
                                ...
                                <td>
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-slate-600 font-medium text-sm">Shoes</span>
                                    </div>
                                </td>
                                <td>
                                    <input type="checkbox" class="toggle toggle-sm toggle-primary" checked />
                                </td>
                                <td class="text-slate-500 font-mono text-xs">SKU-49402</td>
                                <td class="text-slate-700 font-bold">$36.98</td>
                                <td class="text-slate-600 font-medium">528</td>
                                <td>
                            ...
                            <tr class="hover:bg-slate-50/80 transition-colors group">
                                ...
                                <td class="py-3">
                                    <div class="flex items-center gap-4">
                                        <div class="avatar rounded-xl bg-slate-50 p-2 shadow-sm border border-slate-100">
                                            <div class="w-10 h-10 flex items-center justify-center">
                                                 <span class="icon-[tabler--device-watch] size-6 text-slate-500"></span>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="font-bold text-slate-700 text-[15px] group-hover:text-indigo-600 transition-colors">Apple Watch Series 7</div>
                                ...
                                <td>
                                    <div class="flex items-center gap-2">
                                        <div class="bg-slate-100 text-slate-500 p-1.5 rounded-full">
                                            <span class="icon-[tabler--device-watch] size-3.5"></span>
                                        </div>
                                        <span class="text-slate-600 font-medium text-sm">Accessories</span>
                                    </div>
                                </td>
                                <td>
                                    <input type="checkbox" class="toggle toggle-sm toggle-primary" checked />
                                </td>
                                <td class="text-slate-500 font-mono text-xs">SKU-46658</td>
                                <td class="text-slate-700 font-bold">$799.00</td>
                                <td class="text-slate-600 font-medium">851</td>
                                <td>
                                    <span class="badge badge-sm bg-amber-50 text-amber-600 border-amber-100 font-semibold px-2.5 py-0.5">Scheduled</span>
                                </td>
                                <td class="text-right pr-6">
                 ...
                 <div class="p-4 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
                    <div class="text-xs text-slate-500 font-medium">Showing 1 to 5 of <span class="text-slate-800 font-bold">100</span> entries</div>
                    <div class="join shadow-sm border border-slate-200 rounded-lg overflow-hidden">
                        <button class="join-item btn btn-sm bg-white border-none text-slate-400 hover:bg-slate-50 hover:text-slate-600"><span class="icon-[tabler--chevron-left] size-4"></span></button>
                        <button class="join-item btn btn-sm bg-indigo-50 border-none text-indigo-600 font-bold hover:bg-indigo-100">1</button>
                        <button class="join-item btn btn-sm bg-white border-none text-slate-500 hover:bg-slate-50 hover:text-slate-700">2</button>
                         <button class="join-item btn btn-sm bg-white border-none text-slate-500 hover:bg-slate-50 hover:text-slate-700">3</button>
                        <button class="join-item btn btn-sm bg-white border-none text-slate-400 hover:bg-white cursor-default">...</button>
                        <button class="join-item btn btn-sm bg-white border-none text-slate-500 hover:bg-slate-50 hover:text-slate-700">20</button>
                        <button class="join-item btn btn-sm bg-white border-none text-slate-400 hover:bg-slate-50 hover:text-slate-600"><span class="icon-[tabler--chevron-right] size-4"></span></button>
                    </div>
                </div>
            </div>

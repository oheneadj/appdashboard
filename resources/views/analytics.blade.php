<x-layouts::app :title="__('Analytics')">
    <div class="flex flex-col gap-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h1 class="text-2xl font-bold text-slate-800">{{ __('Analytics Overview') }}</h1>
                <p class="text-slate-500 text-sm mt-1">{{ __('Monitor your website traffic and performance') }}</p>
            </div>
            <div class="flex items-center gap-2">
                <div class="relative">
                    ...
                    <input type="text" class="input input-sm input-bordered pl-9 bg-white border-slate-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-slate-600 w-48" value="Last 30 Days" readonly>
                </div>
                <button class="btn btn-sm btn-primary bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white gap-2">
                    <span class="icon-[tabler--download] size-4"></span> {{ __('Export') }}
                </button>
            </div>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y lg:divide-y-0 lg:divide-x divide-slate-100">
                    ...
                    <div class="p-6">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <h3 class="font-semibold text-slate-700 text-sm">{{ __('Total Users') }}</h3>
                        </div>
                        <p class="text-3xl font-bold text-slate-800 mb-2">24.5k</p>
                    ...
                    <div class="p-6">
                         <div class="flex items-center gap-3 mb-2">
                            ...
                            <h3 class="font-semibold text-slate-700 text-sm">{{ __('Sessions') }}</h3>
                        </div>
                        <p class="text-3xl font-bold text-slate-800 mb-2">48.2k</p>
                         <div class="flex items-center gap-2 text-xs">
                    ...
                    <div class="p-6">
                         <div class="flex items-center gap-3 mb-2">
                            ...
                            <h3 class="font-semibold text-slate-700 text-sm">{{ __('Avg. Duration') }}</h3>
                        </div>
                        <p class="text-3xl font-bold text-slate-800 mb-2">4m 32s</p>
                         <div class="flex items-center gap-2 text-xs">
                             <span class="text-emerald-500 font-bold flex items-center gap-0.5">
                    ...
                    <div class="p-6">
                         <div class="flex items-center gap-3 mb-2">
                            ...
                            <h3 class="font-semibold text-slate-700 text-sm">{{ __('Bounce Rate') }}</h3>
                        </div>
                        <p class="text-3xl font-bold text-slate-800 mb-2">42.8%</p>
                         <div class="flex items-center gap-2 text-xs">
                             <span class="text-red-500 font-bold flex items-center gap-0.5">
        ...
        <div class="card bg-white shadow-sm border border-slate-100">
            <div class="card-body p-6">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h3 class="font-bold text-lg text-slate-800">{{ __('Traffic Overview') }}</h3>
                        <p class="text-xs text-slate-500 mt-1">Daily visitors for the last 30 days</p>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <!-- Top Pages Table -->
            <div class="card bg-white shadow-sm border border-slate-100 lg:col-span-2">
                 <div class="card-body p-0">
                    <div class="p-6 border-b border-slate-100 flex justify-between items-center">
                        <h3 class="font-bold text-lg text-slate-800">{{ __('Top Pages') }}</h3>
                    ...
                    <div class="overflow-x-auto">
                        <table class="table w-full">
                            ...
                            <tbody class="text-sm">
                                ...
                                <tr class="hover:bg-slate-50 border-b border-slate-50 last:border-none transition-colors">
                                    <td class="px-6 py-3 font-medium text-slate-700">{{ $page[0] }}</td>
                                    <td class="px-6 py-3 text-right text-slate-600">{{ $page[1] }}</td>
                                    <td class="px-6 py-3 text-right text-slate-500">{{ $page[2] }}</td>
            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="card bg-white shadow-sm border border-slate-100">
                    <div class="card-body p-6">
                        <h3 class="font-bold text-lg text-slate-800 mb-6">{{ __('Device Category') }}</h3>
                        ...
                        <div class="flex justify-center gap-6 mb-6">
                             <div class="flex flex-col items-center gap-2">
                                ...
                                <span class="text-xs font-medium text-slate-500">Mobile</span>
                             </div>
                             <div class="flex flex-col items-center gap-2">
                                <div class="radial-progress text-emerald-500" style="--value:32; --size:4rem; --thickness: 4px;" role="progressbar">
                                    <span class="text-xs font-bold text-slate-700">32%</span>
                                </div>
                                <span class="text-xs font-medium text-slate-500">Desktop</span>
                             </div>
                             <div class="flex flex-col items-center gap-2">
                                ...
                                <span class="text-xs font-medium text-slate-500">Tablet</span>
                             </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- Referrals -->
                <div class="card bg-white shadow-sm border border-slate-100 flex-1">
                    <div class="card-body p-6">
                        <h3 class="font-bold text-lg text-slate-800 mb-4">{{ __('Top Referrals') }}</h3>
                        <div class="space-y-4">
                            @foreach([
                                ...
                                ['Direct', 'bg-slate-100 text-slate-600', 'icon-[tabler--link]', '5%'],
                            ] as $ref)
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-1">
                                    <div class="flex justify-between items-center mb-1">
                                        <span class="font-medium text-slate-700 text-sm">{{ $ref[0] }}</span>
                                        <span class="text-xs font-bold text-slate-600">{{ $ref[3] }}</span>
                                    </div>

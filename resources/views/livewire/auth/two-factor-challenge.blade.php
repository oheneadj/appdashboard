        ...
        <div class="flex flex-col items-center gap-2 text-center">
            ...
            <div x-show="!showRecoveryInput" x-cloak>
                ...
                <p class="text-base-content/70">
                    {{ __('Enter the authentication code provided by your authenticator application.') }}</p>
            </div>
        ...
        <div class="w-full" x-data="{
            ...
            <form method="POST" action="{{ route('two-factor.login.store') }}">
                    ...
                    <div x-show="!showRecoveryInput">
                        <div class="flex items-center justify-center my-5">
                            <div class="form-control w-full max-w-xs mx-auto">
                                ...
                                <input type="text" x-model="code" name="code"
                                    class="input input-bordered text-center tracking-widest text-2xl" maxlength="6"
                                    placeholder="000000" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="my-5">
                            <div class="form-control w-full">
                                <input type="text" name="recovery_code" x-ref="recovery_code"
                                    ...
                                    x-model="recovery_code" class="input input-bordered w-full"
                ...
                <div class="mt-5 space-x-0.5 text-sm leading-5 text-center">
                    ...
                    <div class="inline font-medium link link-primary no-underline cursor-pointer opacity-80">

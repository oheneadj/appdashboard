<x-layouts::app :title="__('Dashboard')">
    <div class="flex flex-col gap-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <!-- Profit -->
            <div
                class="card bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md hover:border-emerald-100 transition-all duration-300 group overflow-hidden relative">
                <div
                ...
                <div class="card-body p-5 relative">
                    <div class="flex items-center justify-between mb-4">
                        <div
                            class="w-11 h-11 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center shadow-md shadow-emerald-200/50">
                    ...
                    <h3 class="text-3xl font-bold text-slate-800 dark:text-slate-100 mt-1">$652K</h3>
                    <!-- Mini Sparkline -->
            ...
            <!-- Sales -->
            <div
                class="card bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md hover:border-blue-100 transition-all duration-300 group overflow-hidden relative">
                <div
                ...
                <div class="card-body p-5 relative">
                    <div class="flex items-center justify-between mb-4">
                        <div
                            class="w-11 h-11 rounded-xl bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center shadow-md shadow-blue-200/50">
                    ...
                    <h3 class="text-3xl font-bold text-slate-800 dark:text-slate-100 mt-1">482K</h3>
            ...
            <!-- Transactions -->
            <div
                class="card bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md hover:border-violet-100 transition-all duration-300 group overflow-hidden relative">
                <div
                ...
                <div class="card-body p-5 relative">
                    <div class="flex items-center justify-between mb-4">
                        <div
                            class="w-11 h-11 rounded-xl bg-gradient-to-br from-violet-400 to-violet-600 flex items-center justify-center shadow-md shadow-violet-200/50">
                    ...
                    <h3 class="text-3xl font-bold text-slate-800 dark:text-slate-100 mt-1">$14,854</h3>
            ...
            <!-- Orders -->
            <div
                class="card bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md hover:border-amber-100 transition-all duration-300 group overflow-hidden relative">
                <div
                ...
                <div class="card-body p-5 relative">
                    <div class="flex items-center justify-between mb-4">
                        <div
                            class="w-11 h-11 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-md shadow-amber-200/50">
                    ...
                    <h3 class="text-3xl font-bold text-slate-800 dark:text-slate-100 mt-1">$1,286</h3>
                    <div class="flex items-center gap-2 mt-3">
                        <div class="flex items-center gap-1">
                            <span class="w-2 h-2 rounded-full bg-amber-400"></span>
                            <span class="text-xs text-slate-500 dark:text-slate-400">156 pending</span>
                        </div>
                        <span class="text-slate-200">|</span>
                        <div class="flex items-center gap-1">
                            <span class="w-2 h-2 rounded-full bg-emerald-400"></span>
                            <span class="text-xs text-slate-500 dark:text-slate-400">89 shipped</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <!-- Total Earning -->
            <div
                class="card bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700 col-span-1">
                <div class="card-body p-6">
                    <div class="flex justify-between items-center mb-1">
                        <h3 class="font-bold text-lg text-slate-800 dark:text-slate-100">{{ __('Total Earning') }}</h3>
                        <button class="btn btn-primary btn-circle text-white"><span
                                class="icon-[tabler--dots-vertical] size-6"></span></button>
                    </div>

                    <div class="mb-6">
                        <div class="flex items-center gap-2">
                            <h2 class="text-3xl font-bold text-slate-800 dark:text-slate-100">$24,650</h2>
                            <span class="text-success text-sm font-bold">^ 10%</span>
                        </div>
                        <p class="text-sm text-slate-500 dark:text-slate-400">{{ __('Compared to $84.325 last year') }}
                        </p>
                    </div>

                    <div class="space-y-6">
                        <div class="flex items-center gap-4">
                            <div class="bg-white dark:bg-slate-800 border rounded-lg p-2"><img
                                    src="https://img.logo.dev/zipcar.com?token=pk_test_123&size=32"
                                    class="size-6 object-contain" alt="Zipcar" /></div>
                            <div class="flex-1">
                                <h4 class="font-semibold text-slate-800 dark:text-slate-100">{{ __('Zipcar') }}</h4>
                                <p class="text-xs text-slate-500 dark:text-slate-400">Vuejs, React & HTML</p>
                            </div>
                            <span class="font-bold text-slate-700 dark:text-slate-200 text-primary">$24,820.35</span>
                        </div>
                        <div class="flex items-center gap-4">
                            <div class="bg-white dark:bg-slate-800 border rounded-lg p-2"><img
                            ...
                            <div class="flex-1">
                                <h4 class="font-semibold text-slate-800 dark:text-slate-100">{{ __('Bitbank') }}</h4>
                                <p class="text-xs text-slate-500 dark:text-slate-400">Sketch, Figma & XD</p>
                            </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <h4 class="font-semibold text-slate-800 dark:text-slate-100">{{ __('Aviato') }}</h4>
                                <p class="text-xs text-slate-500 dark:text-slate-400">HTML & Angular</p>
                            </div>
                            <span class="font-bold text-slate-500 dark:text-slate-400">$55,699.60</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- Total Revenue -->
            <div
                class="card bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700 col-span-1 lg:col-span-2">
                <div class="card-body p-6">
                    <div class="flex justify-between items-center mb-8">
                        <h3 class="font-bold text-lg text-slate-800 dark:text-slate-100">{{ __('Total Revenue') }}</h3>
                        <div class="flex items-center gap-4">
                            <div
                                class="flex items-center gap-1.5 text-xs font-medium text-slate-500 dark:text-slate-400">
                                <span class="w-2.5 h-2.5 rounded-full bg-primary/80"></span> 2024
                            </div>
                            <div
                                class="flex items-center gap-1.5 text-xs font-medium text-slate-500 dark:text-slate-400">
                                <span class="w-2.5 h-2.5 rounded-full bg-info/80"></span> 2023
                            </div>
                            <button class="btn btn-primary btn-circle text-white"><span
                                    class="icon-[tabler--dots-vertical] size-6"></span></button>
                        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="card bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700">
                <div class="card-body p-6">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            <h3 class="font-bold text-lg text-slate-800 dark:text-slate-100">{{ __('Earning Report') }}
                            </h3>
                            <p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1">Weekly Earning
                                Overview</p>
                        </div>
                        <button class="btn btn-primary btn-circle text-white">
                    ...
                    <div class="space-y-6 mb-8">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <h4 class="font-semibold text-slate-700 dark:text-slate-200 text-sm">
                                    {{ __('Net Profit') }}
                                </h4>
                                <p class="text-[11px] text-slate-400 font-medium">12.4k Sales</p>
                            </div>
                            <div class="text-right">
                                <p class="text-sm font-semibold text-slate-600 dark:text-slate-300">-$1,619</p>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="text-right">
                                <p class="text-sm font-semibold text-slate-600 dark:text-slate-300">+$1,260</p>
                                <p class="text-xs text-emerald-500 font-bold flex items-center justify-end gap-1">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="text-right">
                                <p class="text-sm font-semibold text-slate-600 dark:text-slate-300">-$149</p>
                                <p class="text-xs text-emerald-500 font-bold flex items-center justify-end gap-1">
            ...
            <div class="card bg-white dark:bg-slate-800 shadow-sm border border-slate-100 dark:border-slate-700">
                <div class="card-body p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="font-bold text-lg text-slate-800 dark:text-slate-100">{{ __('Transactions') }}</h3>
                        <button class="btn btn-primary btn-circle text-white">
                            <span class="icon-[tabler--dots-vertical] size-6"></span>
                        </button>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <span class="font-bold text-slate-700 dark:text-slate-200 text-sm">-$2,820</span>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <h4 class="font-semibold text-slate-700 dark:text-slate-200 text-sm">{{ __('Paypal') }}
                                </h4>
                                <p class="text-[11px] text-slate-400 font-medium">Received Money</p>
                            </div>
                            <span class="font-bold text-slate-700 dark:text-slate-200 text-sm">+$1,260</span>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <span class="font-bold text-slate-700 dark:text-slate-200 text-sm">-$149</span>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <h4 class="font-semibold text-slate-700 dark:text-slate-200 text-sm">{{ __('Wallet') }}
                                </h4>
                                <p class="text-[11px] text-slate-400 font-medium">Mac'D</p>
                            </div>
                            <span class="font-bold text-slate-700 dark:text-slate-200 text-sm">-$49</span>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <span class="font-bold text-slate-700 dark:text-slate-200 text-sm">-$12,820</span>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <h4 class="font-semibold text-slate-700 dark:text-slate-200 text-sm">{{ __('Stripe') }}
                                </h4>
                                <p class="text-[11px] text-slate-400 font-medium">Buy Apple Watch</p>
                            </div>
                            <span class="font-bold text-slate-700 dark:text-slate-200 text-sm">-$299</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body p-6">
                    <div class="flex justify-between items-center mb-6">
                        <div>
                            ...
                            <p class="text-xs text-slate-500 dark:text-slate-400 font-medium mt-1">42.82k Total Sales
                            </p>
                        </div>
                        <button class="btn btn-primary btn-circle text-white">
                            <span class="icon-[tabler--dots-vertical] size-6"></span>
                    ...
                    <div class="flex justify-between items-center mb-8">
                        <div>
                            <h2 class="text-4xl font-bold text-slate-800 dark:text-slate-100">8,258</h2>
                            <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Total Orders</p>
                        </div>
                        <!-- Radial Chart -->
                        <div class="radial-progress text-primary font-bold text-sm"
                            ...
                            <div class="flex flex-col items-center leading-none">
                                <span class="text-lg font-bold text-slate-800 dark:text-slate-100">38%</span>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between mb-0.5">
                                    ...
                                    <span class="text-slate-700 dark:text-slate-200 font-semibold text-sm">82.5k</span>
                                </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between mb-0.5">
                                    ...
                                    <span class="text-slate-700 dark:text-slate-200 font-semibold text-sm">23.8k</span>
                                </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between mb-0.5">
                                    ...
                                    <span class="text-slate-700 dark:text-slate-200 font-semibold text-sm">849k</span>
                                </div>
                                <p class="text-[11px] text-slate-400 font-medium">ADVT, Marketing</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="w-10 h-10 rounded bg-slate-100 text-slate-500 dark:text-slate-400 flex items-center justify-center">
                            ...
                            <div class="flex-1">
                                <div class="flex justify-between mb-0.5">
                                    ...
                                    <span class="text-slate-700 dark:text-slate-200 font-semibold text-sm">10.9k</span>
                                </div>
            ...
            <div class="card-body p-0">
                ...
                <div
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button
                            class="btn btn-primary gap-2 text-white bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 ml-2">
                            <span class="icon-[tabler--plus] size-5"></span> {{ __('Create Invoice') }}
                        </button>
                    </div>
                    ...
                    <table class="table w-full">
                        ...
                        <thead
                            ...
                            <tr>
                                ...
                                <th class="py-4 px-4 text-slate-600 dark:text-slate-300">
                                    <div class="flex items-center gap-4">
                                        <span>{{ __('Status') }}</span>
                                        <span class="h-4 w-px bg-slate-200"></span>
                                    </div>
                                ...
                                <th class="py-4 px-4 text-slate-600 dark:text-slate-300 text-center">{{ __('Actions') }}
                                </th>
                            </tr>
                        </thead>
                                ...
                                <td class="px-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex flex-col">
                                            <span
                                                class="font-semibold text-slate-700 dark:text-slate-200 leading-tight">Jordan
                                                Stevenson</span>
                                            <span class="text-[11px] text-slate-400">jordanstevenson10@yahoo.com</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 text-slate-600 dark:text-slate-300 font-medium text-base">$4520</td>
                                <td class="px-4 text-slate-500 dark:text-slate-400">22 Jan 2025</td>
                                <td class="px-4">
                                    <span
                            ...
                            <tr
                                ...
                                <td class="px-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex flex-col">
                                            <span
                                                class="font-semibold text-slate-700 dark:text-slate-200 leading-tight">Olivia
                                                Peterson</span>
                                            <span class="text-[11px] text-slate-400">olivia.peterson@example.com</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 text-slate-600 dark:text-slate-300 font-medium text-base">$120</td>
                                <td class="px-4 text-slate-500 dark:text-slate-400">25 Jan 2025</td>
                                <td class="px-4 text-slate-500 dark:text-slate-400 font-medium">-$205</td>
                                <td class="px-4">
                                    <div class="flex items-center justify-center gap-3 text-slate-400">
                                        <button class="hover:text-slate-600 dark:text-slate-300 transition-colors"
                                            title="Delete"><span
                            ...
                            <tr
                                ...
                                <td class="px-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex flex-col">
                                            <span
                                                class="font-semibold text-slate-700 dark:text-slate-200 leading-tight">Liam
                                                Johnson</span>
                                            <span class="text-[11px] text-slate-400">liam.johnson@mail.com</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 text-slate-600 dark:text-slate-300 font-medium text-base">$1850</td>
                                <td class="px-4 text-slate-500 dark:text-slate-400">01 Feb 2025</td>
                                <td class="px-4">
                                    <span class="text-slate-500 dark:text-slate-400 font-medium">-$205</span>
                                </td>
                                <td class="px-4">
                                    <div class="flex items-center justify-center gap-3 text-slate-400">
                                        <button class="hover:text-slate-600 dark:text-slate-300 transition-colors"
                            ...
                            <tr
                                ...
                                <td class="px-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex flex-col">
                                            <span
                                                class="font-semibold text-slate-700 dark:text-slate-200 leading-tight">Sophia
                                                Lee</span>
                                            <span class="text-[11px] text-slate-400">sophia.lee@example.com</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 text-slate-600 dark:text-slate-300 font-medium text-base">$755</td>
                                <td class="px-4 text-slate-500 dark:text-slate-400">26 Jan 2025</td>
                                <td class="px-4">
                                    <span
                                        class="bg-emerald-100/60 text-emerald-600 px-2 py-0.5 rounded text-[11px] font-bold tracking-wide uppercase">Paid</span>
                                </td>
                            ...
                            <tr
                                ...
                                <td class="px-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="flex flex-col">
                                            <span
                                                class="font-semibold text-slate-700 dark:text-slate-200 leading-tight">Ethan
                                                Harris</span>
                                            <span class="text-[11px] text-slate-400">ethan.harris@example.com</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 text-slate-600 dark:text-slate-300 font-medium text-base">$430</td>
                                <td class="px-4 text-slate-500 dark:text-slate-400">30 Jan 2025</td>
                                <td class="px-4 text-slate-500 dark:text-slate-400 font-medium">$666</td>
                                <td class="px-4">
                                    <div class="flex items-center justify-center gap-3 text-slate-400">
                                        <button class="hover:text-slate-600 dark:text-slate-300 transition-colors"
                                            title="Delete"><span
                ...
                <!-- Footer / Pagination -->
                <div
                    class="p-5 flex flex-col sm:flex-row gap-4 justify-between items-center border-t border-slate-100 dark:border-slate-700">
                    <p class="text-slate-400 text-sm">Showing 1 to 5 of 17 entries</p>

                    <div class="join">
                        <button
                            class="join-item btn btn-sm bg-slate-100 border-none text-slate-500 dark:text-slate-400 hover:bg-slate-200"><span
                        ...
                        <button
                            class="join-item btn btn-sm bg-slate-50 border-none text-slate-500 dark:text-slate-400 hover:bg-slate-200">2</button>
                        <button
                            class="join-item btn btn-sm bg-slate-50 border-none text-slate-500 dark:text-slate-400 hover:bg-slate-200">3</button>
                        <button
                            class="join-item btn btn-sm bg-slate-50 border-none text-slate-500 dark:text-slate-400 hover:bg-slate-200">4</button>
                        <button
                            class="join-item btn btn-sm bg-slate-50 border-none text-slate-500 dark:text-slate-400 hover:bg-slate-200">5</button>
                        <button
                            class="join-item btn btn-sm bg-slate-100 border-none text-slate-500 dark:text-slate-400 hover:bg-slate-200"><span
